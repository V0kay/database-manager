...
/*At this current point I realized that "strupr" isnt a defualt function...Please add this to your directories.  (If you are not versed in this "strupr" converts
a string into uppercase.) Thank you -V0kay */
...
int ADMIN::addstaff(){
	...
	//"strlwr" is also not a common function...go to ln 219 for more details   
	title();
